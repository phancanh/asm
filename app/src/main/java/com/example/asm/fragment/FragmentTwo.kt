...
import com.example.asm.databinding.FragmentTwoBinding
...
class FragmentTwo : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.nameRestaurant.observe(requireActivity()) {
            items.clear()
        ...
        binding.next.setOnClickListener {
            ...
            viewModel.setDish(selectedValue)
            viewModel.setName(selectedValue)
